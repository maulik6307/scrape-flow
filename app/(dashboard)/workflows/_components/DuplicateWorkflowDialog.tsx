...
const DuplicateWorkflowDialog = ({ workflowId }: { workflowId?: string }) => {
    ...
    const { mutate, isPending } = useMutation({
        ...
        onError: () => {
            toast.error("Failed to duplicated workflow", { id: "duplicate-workflow" })
        }
    })
                    ...
                    <Form {...form} >
                        <form className='space-y-8 w-full' onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className='flex gap-1 items-center'>Workflow description
                                        ...
                                        <FormDescription>
                                            Provide a brief description of what your workflow does. <br /> This is optional but can help you remember what your workflow is for.
                                        </FormDescription>
                                    </FormItem>
                                )}
                            />
