...
const DeleteCredentialDialog = ({ name }: Props) => {
    ...
    const deleteMutation = useMutation({
        ...
        onError: () => {
            toast.error('Failed to delete credentail', { id: name })
            setConfirmText('')
        }
    })
    return (
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        If you delete this Credentaial, you will not be able to recover it.
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel onClick={() => setConfirmText('')}>Cancle</AlertDialogCancel>
